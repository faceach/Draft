/**
 * @license AngularJS v1.4.0-local+sha.8c46919
...
function minErr(module, ErrorConstructor) {
  ...
  return function() {
    ...
    message += '\nhttp://errors.angularjs.org/1.4.0-local+sha.8c46919/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.4.0-local+sha.8c46919',    // all of these placeholder strings will be replaced by grunt's
